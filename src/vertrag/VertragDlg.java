...
public class VertragDlg extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jtBeginnJahr = new javax.swing.JFormattedTextField(vertrag.getBeginnJahr());
        ...
        schliessfach = new javax.swing.JFormattedTextField(vertrag.getSchliessfach());
        ...
        jtBeginnJahr.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        jtBeginnJahr.setName("jtBeginnJahr"); // NOI18N
        jtBeginnJahr.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
        ...
        cbBeginnSommer.addChangeListener(new javax.swing.event.ChangeListener() {
        ...
        jtEndeJahr.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        jtEndeJahr.setName("jtEndeJahr"); // NOI18N
        jtEndeJahr.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(fachZuordnen, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(fachFreigeben, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE))
                .addContainerGap())
        );
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(jtEndeJahr)
                                            .addComponent(jtBeginnJahr))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(cbBeginnSommer, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(cbEndeSommer, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addComponent(jtID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(schliessfach, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jtSchueler, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(18, 18, 18)
                        .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jbSchliessen, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jtSchueler, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jtBeginnJahr, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jtEndeJahr, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cbEndeSommer))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                            .addComponent(schliessfach, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addComponent(jLabel6))
                    .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void fachZuordnenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fachZuordnenActionPerformed
        if(vertrag.getSchliessfach() != null){
            JOptionPane.showMessageDialog(this.getParent(), "Es it bereits ein Schliessfach zugeordnet.\nGeben Sie dieses zunächst frei.", "Schließfach zuordnen", JOptionPane.ERROR_MESSAGE);
            return;
        }
        SchliessfachAuswahlDlg dlg = new SchliessfachAuswahlDlg(SchliessfachApp.getApplication().getMainFrame(), vertrag);
    ...
    private void fachFreigebenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fachFreigebenActionPerformed
        if(vertrag.getSchliessfach() == null)
            return;
        Query q = em.createQuery("SELECT s FROM Schluessel s WHERE s.schliessfach.nr="+vertrag.getSchliessfach().getNr()+" AND s.ausgegeben=true");
        List l = q.getResultList();
        if(l != null && l.size() > 0){
            JOptionPane.showMessageDialog(this.getParent(), "Das Schließfach kann nicht freigegeben werden.\nEs ist noch mindestens ein Schlüssel ausgegeben.", "Schließfach freigeben", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VertragDlg dialog = new VertragDlg(new javax.swing.JFrame(), new Vertrag());
